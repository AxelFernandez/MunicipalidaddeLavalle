 ...
 */
public class Fragment_Alojamientos extends Fragment {

    HttpURLConnection connection;
    public Fragment_Alojamientos() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (list.get(0).getTitulo().equals("No hay conexion a internet")) {
            return nc;
        }
        ...
        protected List<Sitios_Entity> doInBackground(String... urls) {
            ...
            try {
                if (conectadoAInternet()) {
                    ...
                    try{
                        URL url1 = new URL("http://lavallemendoza.gob.ar/public/webservice/alojamientos");
