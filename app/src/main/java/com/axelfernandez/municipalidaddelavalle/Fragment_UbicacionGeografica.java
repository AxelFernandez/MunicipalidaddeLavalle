 ...
 */
public class Fragment_UbicacionGeografica extends Fragment {


    public Fragment_UbicacionGeografica() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] titulo = res.getStringArray(R.array.nombres);
        String[] desc = res.getStringArray(R.array.descripcion);
